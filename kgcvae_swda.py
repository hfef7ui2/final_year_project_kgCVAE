...
# tf.app.flags.DEFINE_string("data_dir", "data/full_swda_clean_42da_sentiment_dialog_corpus.p", "Raw data directory.")#dialog data
tf.app.flags.DEFINE_string("data_dir", "data/corpus_with_emotion.p", "Raw data directory.")#dialog data
...
tf.app.flags.DEFINE_string("test_path", "run1509782725", "the dir to load checkpoint for forward only")
