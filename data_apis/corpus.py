...
class SWDADialogCorpus(object):
    ...
    def __init__(self, corpus_path, max_vocab_cnt=10000, word2vec=None, word2vec_dim=None):
        ...
        print(type(data['test'][0]['utts'][0]))
        print(data['test'][0]['utts'][0][1])
        ...
        self.load_word2vec()
        print("type(self.test_corpus):")
        print(type(self.test_corpus))
        print(len(self.test_corpus[0]))
        print(len(self.test_corpus[0][0]))

        print(self.test_corpus[0][0])
    ...
    def build_vocab(self, max_vocab_cnt):
        ...
        print(type(vocab_count))
        print(len(vocab_count))
        print(vocab_count[-1])
        print(vocab_count[0])
        print(vocab_count[1])
        self.vocab = ["<pad>", "<unk>"] + [t for t, cnt in vocab_count]#an array
